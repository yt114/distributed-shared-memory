...
execute_process(
  COMMAND "/usr/bin/git" show-ref RELEASE_TAG_HERE
  WORKING_DIRECTORY "/home/ye/Documents/distributed-shared-memory/cmake-build-debug/_deps/grpc-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/RELEASE_TAG_HERE")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "RELEASE_TAG_HERE")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "RELEASE_TAG_HERE")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 RELEASE_TAG_HERE
  WORKING_DIRECTORY "/home/ye/Documents/distributed-shared-memory/cmake-build-debug/_deps/grpc-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/grpc/grpc'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ye/Documents/distributed-shared-memory/cmake-build-debug/_deps/grpc-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ye/Documents/distributed-shared-memory/cmake-build-debug/_deps/grpc-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
